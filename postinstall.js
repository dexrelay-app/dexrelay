...
function renderHelpfulCommands() {
  ...
  return [
    ...
    "  dexrelay agent-speedup report  Find slow/heavy agent state and stale iOS temp builds",
    "  dexrelay agent-speedup apply   Back up state and clean safe candidates",
